...
@GameServiceRegistry.register(GameModes.GUESS_COUNTRY_FROM_FLAG_TRAINING_INFINITE)
class GameServiceGuessCountryFromFlagTrainingInfinite(GameServiceGuessCountryFromFlagBase):
