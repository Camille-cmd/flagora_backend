...
from api.services.game_modes.training_modes.game_guess_department_from_number import (
...
class DepartmentGameModeTestCase(TestCase):
    def setUp(self):
        ...
        self.dept2 = Department.objects.create(number="75", name="Paris", region="Île-de-France", prefecture="Paris")
    ...
    def test_user_department_score_creation(self):
        ...
        score = UserDepartmentScore.objects.create(
            user=self.user, department=self.dept1, game_mode=GameModes.GUESS_DEPARTMENT_FROM_NUMBER_TRAINING_INFINITE
        )
    ...
    def test_department_score_service(self):
        ...
        service = UserDepartmentScoreService(self.user, GameModes.GUESS_DEPARTMENT_FROM_NUMBER_TRAINING_INFINITE)
